...
/**
 * ExperiencesSearch represents the model behind the search form of `backend\models\Experiences`.
 */
class ExperiencesSearch extends Experiences
{
    ...
    public function rules()
    {
        return [
            ...
            [['experience', 'name_company', 'start_date', 'end_date', 'description_work'], 'safe'],
        ];
    }
